...
static HTS221_StatusTypeDef I2C_Read(uint16_t DevAddress, uint16_t MemAddress, uint8_t *pData, uint16_t Size,
                                     uint32_t Timeout)
{
    HTS221_StatusTypeDef ret;

    ret = (HTS221_StatusTypeDef)HAL_I2C_Mem_Read(&hi2c1, DevAddress, MemAddress, I2C_MEMADD_SIZE_8BIT, pData, Size,
            Timeout);

    return ret;
}

static HTS221_StatusTypeDef I2C_Write(uint16_t DevAddress, uint16_t MemAddress, uint8_t *pData, uint16_t Size,
                                      uint32_t Timeout)
{
    HTS221_StatusTypeDef ret;

    ret = (HTS221_StatusTypeDef)HAL_I2C_Mem_Write(&hi2c1, DevAddress, MemAddress, I2C_MEMADD_SIZE_8BIT, pData, Size,
            Timeout);
